...
// Benchmark represents a benchmark instance
...
func (b *Benchmark) runWorker(ctx context.Context, threadID int, requestCount, errorCount *int64, results *stats.Results) {
...
func (b *Benchmark) runConnection(ctx context.Context, requestCount, errorCount *int64, results *stats.Results) {
...
func (b *Benchmark) createRateLimiter() <-chan time.Time {
	if b.config.Rate <= 0 {
		return nil
	}
